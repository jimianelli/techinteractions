...
##############################################################################	
	...
	gc()
	library(reshape2)
	setwd("C:/Users/Kotou/Dropbox/Postdoc_projects/Technical_int/techinteractions_scenario36b/R")
...
##################### Case 1: without the gear constraints:
	...
	Without_gear_constraints(Yr=NULL,max_dk=5, min_dk=0.2, CV_strategy=NULL, seed=11)

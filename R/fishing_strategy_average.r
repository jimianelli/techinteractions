...
################### Case 1: without the gear constraints:
	...
	Change_strategy=FALSE;		## YES or NO
	...
	Without_gear_constraints(Yr=NULL, Bounds_base = "cluster", Change_strategy=FALSE, seed=seed_val, price_change = FALSE, price_min=0.2, price_factor=0.5)
